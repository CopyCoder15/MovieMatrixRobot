...
BOT_TOKEN = environ.get('BOT_TOKEN', "7963198119:AAEdzpcHYsX3a03kFdC1PgbksF6qMKitGR8")
...
premium = environ.get('PREMIUM_LOGS', '-1002490649550)
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7795988203').split()]
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "SarkarFF45") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002157247664').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://safari:safari@cluster0.i6xwiol.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002490649550))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002476256517)) # Group verify stats 
